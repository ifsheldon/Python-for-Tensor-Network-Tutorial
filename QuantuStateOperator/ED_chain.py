...
linear_fun = LinearOperator(
    (16, 16), lambda x: heisenberg_hamilt_on_psi(x, hamilt.reshape(2, 2, 2, 2))
)
ge2, gs2 = eigsh(linear_fun, k=1, which="SA")
print("- 匿名函数 + LinearOperator, \t 基态能量 = %g " % ge2[0])
# ====================================================

ge3, gs3 = ED_ground_state(hamilt.reshape(2, 2, 2, 2), pos=[[0, 1], [1, 2], [2, 3]])
print("- 直接调用Library.ED.ED_ground_state, \t 基态能量 = %g " % ge1[0])
