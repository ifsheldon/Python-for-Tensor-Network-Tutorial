...
infor_s, _ = ResMPS_classifier(train_loader, test_loader, para=para, paraMPS=paraMPS)

para["ResMPS"] = "activated"
paraMPS["activation"] = "ReLU"
infor_a, _ = ResMPS_classifier(train_loader, test_loader, para=para, paraMPS=paraMPS)
