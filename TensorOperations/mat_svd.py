...
print("--------------------- 分割线 ---------------------")
d1, d2 = 3, 4
M2 = tc.einsum("a,b->ab", tc.randn(d1, dtype=tc.complex128), tc.randn(d2, dtype=tc.complex128))
s = tc.linalg.svdvals(M2)
print("The singular values of a matrix from the outer product of two vectors:")
print(s)
